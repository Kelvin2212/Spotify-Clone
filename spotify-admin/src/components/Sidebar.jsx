...
const Sidebar = () => {
  return (
    <div className="bg-[#003A10] min-h-screen pl-[3vw] w-[20vw]">
      {" "}
      {/* Increased width */}
      <img
        src={assets.logo}
        className="mt-5 w-[max(10vw, 100px)] hidden sm:block" // Increased width
        alt=""
      />
      <img
        src={assets.logo_small}
        className="mt-5 w-[max(5vw, 40px)] mr-5 sm:hidden block" // Increased width
        alt=""
      />
